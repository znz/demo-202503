...
argocd app create demo1-cilium --repo "ssh://git@$(ifconfig en0 | awk '$1=="inet"{print $2}'):20022/repos/demo1" --path cilium --dest-namespace default --dest-server https://kubernetes.default.svc --sync-policy auto --auto-prune --self-heal
...
argocd app create demo1-k8s-monitoring --repo "ssh://git@$(ifconfig en0 | awk '$1=="inet"{print $2}'):20022/repos/demo1" --path k8s-monitoring --dest-namespace default --dest-server https://kubernetes.default.svc --sync-policy auto --auto-prune --self-heal
